...
<head>
    ...
    <!-- Site Meta -->
    <title>Our Projects - Spark Tech</title>
...
<?php include 'header-plain.php';?>
        <section class="section lb p120">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="tagline-message page-title text-center wow slideInUp asd">
                            <!-- <h3>Our Project</h3> -->
                            <h3>
                                <div class="animation">
                                    <span style="color: #000; font-size: 34px;" class="first">Our</span> 
                                    <span class="oh">
                            ...
                            <!-- <ul class="breadcrumb"> -->
                                <!-- <li><a href="index.html">Spark Tech</a></li> -->
                ...
                <div class="boxed boxedp4">
                    ...
                    <div class="row blog-grid shop-grid">
                        <div class="col-md-4 wow fadeInUp">
                            <div class="course-box shop-wrapper">
                                <div class="image-wrap entry">
                                    <img src="images/img/extra/project-new-1.jpg" alt="" class="img-responsive">
                                    <!-- <div class="magnifier">
                                ...
                                <div class="course-details shop-box text-center">
                                    ...
                                    <div class="btn-enroll">
                                        <a class="btn btn-primary" href="project-details.php">Read More</a>
                                    </div>
                                </div>
                                <!-- end details -->
                            </div><!-- end box -->
                        ...
                        <div class="col-md-4 wow fadeInUp">
                            <div class="course-box shop-wrapper">
                                <div class="image-wrap entry">
                                    <img src="images/img/extra/project-new-2.jpg" alt="" class="img-responsive">
                                    <!-- <div class="magnifier">
                                        <a href="#" title=""><i class="flaticon-add"></i></a>
                                    </div> -->
                                </div>
...
<!--                                         <div style="float: left;">
                                        ...
                                        <div style="float: right;">
                                            <a href="me-iot-proj.html" title="">Java</a>    
                                        </div> -->
                                        Project Name
                                        <!-- <small>Software</small> -->
                                    </h4>
                        ...
                        <div class="col-md-4 wow fadeInUp">
                            <div class="course-box shop-wrapper">
                                <div class="image-wrap entry">
                                    <img src="images/img/extra/project-new-3.jpg" alt="" class="img-responsive">
                                    <!-- <div class="magnifier">
                                        <a href="#" title=""><i class="flaticon-add"></i></a>
                                    </div> -->
                                </div>
                ...
                <div class="row">
                    <div class="col col-xs-12">
                        <div class="partner-grids partners-slider">
                            <div class="grid">
                                <img src="images/img/extra/c++-new-1.jpg" alt>
                            </div>
                            <div class="grid">
                                <img src="images/img/extra/cyber-security-new-1.jpg" alt>
                            </div>
                            <div class="grid">
                                <img src="images/img/extra/cyber-security-new-1.jpg" alt>
                            </div>
                            ...
                            <div class="grid">
                                <img src="images/img/extra/arduino-new-1.jpg" alt>
                            </div>
                        </div>
                    </div>
                </div>
...
</script><link href="https://owlcarousel2.github.io/OwlCarousel2/assets/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
...
<section class="section"> -->
    <!--Head is included for easy understanding  -->
<!-- <head>
    <meta charset="utf-8">
...
<section class="section section-xyz">
    <div class="container">
    <div class="rotator">
      ...
      <div class="items"><img src="https://cdn.pixabay.com/photo/2017/02/01/22/02/mountain-landscape-2031539__340.jpg" alt="items photo" /></div>
...
<section class="section wrapper-full tab-container effectTab-header" id="style_1" style="padding-top:170px;">
...
<!--               <li data-filter="*" class="filter-active">All</li>
              ...
              <li data-filter=".filter-card">Mobile App Development</li>
              <li data-filter=".filter-web">Graphics Work</li> -->
            </ul>
          </div>
        </div>
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 filter-app">
            <div class="portfolio-item">
              <img src="images/img/extra/advance-java-new-1.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h3><a data-gall="portfolioGallery" class="venobox" title="Project 1">Project 1</a></h3>
                <div>
                  <!-- <a href="assets/img/portfolio/portfolio-1.jpg" data-gall="portfolioGallery" class="venobox" title="E-Commerce"><i class="bx bx-plus"></i></a> -->
                  <!-- <a href="medikal.php" title="Portfolio Details"><i class="bx bx-link"></i></a> -->
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 filter-web">
            <div class="portfolio-item">
              <img src="images/img/extra/arduino-new-1.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h3><a data-gall="portfolioGallery" class="venobox" title="Project 2">Project 2</a></h3>
                <div>
                  <!-- <a href="assets/img/portfolio/portfolio-2.jpg" data-gall="portfolioGallery" class="venobox" title="Travel & Tourism"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 filter-web">
            <div class="portfolio-item">
              <img src="images/img/extra/c++-new-1.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h3><a data-gall="portfolioGallery" class="venobox" title="Project 3">Project 3</a></h3>
                <div>
                  <!-- <a href="assets/img/portfolio/portfolio-3.jpg" data-gall="portfolioGallery" class="venobox" title="International Trade"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.php" title="Portfolio Details"><i class="bx bx-link"></i></a> -->
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 filter-web">
            <div class="portfolio-item">
              <img src="images/img/extra/me-mtech-new-1.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h3><a data-gall="portfolioGallery" class="venobox" title="Project 4">Project 4</a></h3>
                <div>
                  <!-- <a href="assets/img/portfolio/portfolio-3.jpg" data-gall="portfolioGallery" class="venobox" title="International Trade"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.php" title="Portfolio Details"><i class="bx bx-link"></i></a> -->
                </div>
          ...
          <div class="col-lg-4 col-md-6 filter-web">
            <div class="portfolio-item">
              <img src="images/img/extra/diploma-pro-new-1.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h3><a data-gall="portfolioGallery" class="venobox" title="Project 5">Project 5</a></h3>
                <div>
                  <!-- <a href="assets/img/portfolio/portfolio-3.jpg" data-gall="portfolioGallery" class="venobox" title="International Trade"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.php" title="Portfolio Details"><i class="bx bx-link"></i></a> -->
                </div>
          ...
          <div class="col-lg-4 col-md-6 filter-web">
            <div class="portfolio-item">
              <img src="images/img/extra/industrail-new-1.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h3><a data-gall="portfolioGallery" class="venobox" title="Project 6">Project 6</a></h3>
                <div>
                  <!-- <a href="assets/img/portfolio/portfolio-3.jpg" data-gall="portfolioGallery" class="venobox" title="International Trade"><i class="bx bx-plus"></i></a>
                  <a href="portfolio-details.php" title="Portfolio Details"><i class="bx bx-link"></i></a> -->
                </div>
...
<!--     <script>
    ...
    <script src="assets/carousel/owl.js"></script> -->
